...
public interface Pipelines
{
    ...
    PipelineConstructor FONT_BITMAP = (device, extent, renderPass, setLayouts) -> PipelineBuilder
        .create(device)
        .shaders()
            .addShader(ShaderSPIRVUtils.ShaderKind.VERTEX_SHADER, "volkaniums/shaders/font_bitmap.vert", VK_SHADER_STAGE_VERTEX_BIT)
            .addShader(ShaderSPIRVUtils.ShaderKind.FRAGMENT_SHADER, "volkaniums/shaders/font_bitmap.frag", VK_SHADER_STAGE_FRAGMENT_BIT)
            .done()
    ...
    PipelineConstructor FONT_SDF = (device, extent, renderPass, setLayouts) -> PipelineBuilder
        .create(device)
        .shaders()
            .addShader(ShaderSPIRVUtils.ShaderKind.VERTEX_SHADER, "volkaniums/shaders/font_sdf.vert", VK_SHADER_STAGE_VERTEX_BIT)
            .addShader(ShaderSPIRVUtils.ShaderKind.FRAGMENT_SHADER, "volkaniums/shaders/font_sdf.frag", VK_SHADER_STAGE_FRAGMENT_BIT)
            .done()
